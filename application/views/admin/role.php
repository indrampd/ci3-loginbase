...
<div class="container-fluid">
   ...
   <div class="row">
      <div class="col-lg-12">
         ...
         <a href="" class="btn btn-sm btn-primary mb-3" data-toggle="modal" data-target="#roleBaruModal">Tambah role baru</a>
            ...
            <tbody>
               ...
               <?php foreach ($role as $r) { ?>
                  <tr>
                     ...
                     <td><?= $r['role'] ?></td>
                     <td>
                        <a href="<?= base_url('admin/roleaccess/' . $r['id']) ?>" class="btn btn-sm btn-success">Akses</a>
                     </td>
                  </tr>
               <?php } ?>
            </tbody>

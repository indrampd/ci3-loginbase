...
<div class="container-fluid">
   ...
   <div class="row">
      <div class="col-lg">
         ...
         <a href="" class="btn btn-sm btn-primary mb-3" data-toggle="modal" data-target="#submenuBaruModal">Tambah Submenu baru</a>
            ...
            <tbody>
               ...
               <?php foreach ($subMenu as $sm) { ?>
                  <tr>
                     ...
                     <td><?= $sm['is_active'] ?></td>
                     <td>
                        <a href="<?= base_url('menu/updatesubmenu/' . $sm['id']) ?>" class="btn btn-sm btn-success">Edit</a>
                        <a href="<?= base_url('menu/deletesubmenu/' . $sm['id']) ?>" class="btn btn-sm btn-danger">Delete</a>
                     </td>
                  <?php } ?>
            </tbody>
         </table>

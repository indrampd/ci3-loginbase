...
<div class="container-fluid">
   ...
   <div class="row">
      <div class="col-lg-12">
         ...
         <a href="" class="btn btn-sm btn-primary mb-3" data-toggle="modal" data-target="#menuBaruModal">Tambah Menu baru</a>
            ...
            <tbody>
               ...
               <?php foreach ($menu as $m) { ?>
                  <tr>
                     ...
                     <td><?= $m['menu'] ?></td>
                     <td>
                        <a href="<?= base_url('menu/updatemenu/' . $m['id']) ?>" class="btn btn-sm btn-success">Edit</a>

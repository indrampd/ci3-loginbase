...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Jan 2021 pada 21.44
...
(5, 3, 'Submenu Manegement', 'menu/submenu', 'fas fa-fw fa-folder-open', 1),
(7, 1, 'Role', 'admin/role', 'fas fa-fw fa-users', 1),
(8, 2, 'Ubah Password', 'user/changepassword', 'fas fa-fw fa-key', 1),
(9, 11, 'Daftar Buku', 'perpustakaan', 'fas fa-fw fa-swatchbook', 1),
(11, 11, 'Daftar Peminjaman Buku', 'perpustakaan/pinjam', 'fas fa-fw fa-clipboard-list', 1);
